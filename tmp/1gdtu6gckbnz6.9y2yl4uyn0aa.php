        ...
        <div class="mx-5 container p-4 border border-secondary rounded">
            ...
            <form action="" method="post">
                <div class="row">
                    ...
                    <!--Phone Number-->
                    <div class="col-8">
                        <label for="primeMember" class="form-label font-weight-bold custom-checkbox mb-1">Premium Membership
                        </label>
                        <br>
                        <input class="" type="checkbox" value="primeMember" id="primeMember" name="primeMember">
